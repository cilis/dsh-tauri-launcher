      ...
      if (window.parent !== window) {
        ...
        const initNav = () => {
          ...
          const sendStatus = () => {
            ...
            navDiag('nav-status', 'back=' + payload.__tbNavStatus.back + ' forward=' + payload.__tbNavStatus.forward + ' targetOrigin=*')
          }
          ...
          const onNavMessage = (event) => {
            ...
            if (data.__tbNavEcho) {
              navDiag('nav-echo', JSON.stringify(data.__tbNavEcho))
              return
            }
            const dir = data.__tbNav
            navDiag('nav-message', 'dir=' + dir + ' origin=' + event.origin + ' originOk=' + (event.origin === parentOrigin))
